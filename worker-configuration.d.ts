/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 649b811f39d8ba1760e42f632e8bb23c)
// Runtime types generated with workerd@1.20250617.0 2025-07-05 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		DPOP_SESSION_STORE: KVNamespace;
		DPOP_STATE_STORE: KVNamespace;
		SECRET: string;
		PRIVATE_JWK: string;
		ASSETS: Fetcher;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SECRET" | "PRIVATE_JWK">> {}
}
